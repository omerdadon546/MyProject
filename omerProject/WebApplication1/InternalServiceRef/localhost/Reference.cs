...
namespace WebApplication1.localhost {
    ...
    public partial class WebService1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void IsStrongPasswordAsync(string password) {
            this.IsStrongPasswordAsync(password, null);
        }
        
        /// <remarks/>
        public void IsStrongPasswordAsync(string password, object userState) {
            ...
            this.InvokeAsync("IsStrongPassword", new object[] {
                        password}, this.IsStrongPasswordOperationCompleted, userState);
        }
